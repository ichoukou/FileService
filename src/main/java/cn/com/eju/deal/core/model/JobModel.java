...
public class JobModel  {
    ...
    private Class<? extends Job> stateFulljobExecuteClass;//同步的执行类，需要从StatefulMethodInvokingJob继承  
	...
	public Class<? extends Job> getStateFulljobExecuteClass() {
		return stateFulljobExecuteClass;
	}
	public void setStateFulljobExecuteClass(
			Class<? extends Job> stateFulljobExecuteClass) {
