...
public class AuthUtil
{
    ...
    * @throws Exception
    */
    public static String sign(String jsonStr, String secret)
        throws Exception
    {
        //待加密
     ...
     * @param HashMap<String,String> params 请求参数集，所有参数必须已转换为字符串类型  (HTTP GET)
     * @return 签名
     * @throws Exception
     */
    @Deprecated
    public static String getSignature(String secret, Map<String, Object> reqMap)
        throws Exception
    {
     ...
     */
    @Deprecated
    public static String getSignature(String secret, String dto)
        throws Exception
    {
    ...
    public static String getSignature(String secret, Map<String, Object> reqMap, String dto)
        throws Exception
    {
    ...
    */
    @Deprecated
    public static String signTopRequest(Map<String, Object> params, String secret, String signMethod)
        throws Exception
    {
        // 第一步：检查参数是否已经排序
