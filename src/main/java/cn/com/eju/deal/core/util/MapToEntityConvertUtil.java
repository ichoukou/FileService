...
import cn.com.eju.deal.core.convert.ConvertFactory;

/**   
* 序列化数据转对象
* TODO（BigDecimal类型暂不能处理）
* @author (li_xiaodong)
* @date 2016年4月30日 下午12:03:56
*/
public class MapToEntityConvertUtil
{
    
    private static Log log = LogFactory.getLog(MapToEntityConvertUtil.class);
    ...
    public static <T> T convert(Map valueMap, Class<T> entityClass, String prefix)
    {
        ...
        {
            log.error("create " + entityClass.getName() + " instance failed, Do it has a empty constructed function ?",
                e);
            return null;
        }
